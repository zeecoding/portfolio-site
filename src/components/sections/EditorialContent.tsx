    ...
    <div ref={container}>
      ...
      <section className="relative min-h-screen py-48 px-6 overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto w-full grid grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-10 col-start-2 min-[375px]:col-span-8 min-[375px]:col-start-1 min-[425px]:col-span-9 min-[425px]:col-start-1 md:col-span-12 md:col-start-1 md:ml-0 lg:col-span-5 lg:col-start-auto lg:-ml-24 editorial-overlap">
